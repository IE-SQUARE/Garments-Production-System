...
def bulk_import_buyer():
    ...
    if file and file.filename.endswith('.csv'):
        ...
        # স্পেসজনিত সমস্যা এড়াতে fieldnames গুলোকে পরিষ্কার (strip) করা হয়েছে
        ...
        try:
            for row in reader:
                # এখন row['Buyer'] লিখলেই কাজ করবে, বাড়তি স্পেস থাকলেও সমস্যা নেই
                cur.execute("""
            ...
            conn.rollback()
            # এররটি আসলে কী তা দেখার জন্য এটি সাহায্য করবে
