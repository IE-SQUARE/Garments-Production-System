...
def bulk_import_buyer():
    ...
    if file and file.filename.endswith('.csv'):
        # CSV ফাইল পড়ার সময় ইনকোডিং হ্যান্ডেল করা
        csv_file = TextIOWrapper(file.stream, encoding='utf-8-sig') # 'utf-8-sig' দিলে ইনভিজিবল ক্যারেক্টার রিমুভ হয়
        reader = csv.DictReader(csv_file)
        
        # কলামের নামগুলো থেকে বাড়তি স্পেস মুছে ফেলা (Strip Column Names)
        ...
        try:
            for row in reader:
                # row.get() ব্যবহার করে স্পেস ছাড়া নামগুলো দিয়ে ডাটা নেওয়া
